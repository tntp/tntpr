...
if(!suppressPackageStartupMessages(require("tntpr"))) { p_load(devtools); devtools::install_github("tntp/tntpr") }
p_load(knitr, tntpr, readr, readxl, dplyr, magrittr, ggplot2, stringr, devtools, scales, janitor, tidyr, here)

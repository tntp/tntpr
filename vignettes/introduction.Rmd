...
```{r}
rec_levels <- c("Screen Out", "Recommend with Reservations", "Recommend without Hesitation", "Recommend", "Highly Recommend")

ratings <- tibble(id = 1:100, 
                  first_rating = sample(rec_levels, 100, replace = TRUE), 
                  second_rating = sample(rec_levels, 100, replace = TRUE))
ratings %>% 
  factorize_df(lvls = c("Screen Out", "Recommend with Reservations", "Recommend without Hesitation", "Recommend", "Highly Recommend"))
```

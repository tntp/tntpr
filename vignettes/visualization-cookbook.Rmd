...
ggplot(
  ...
  scale_fill_manual(values = tntp_colors('green', 'medium_green', 'light_green', 'light_gray')) +
...
```{r}
agree_scale_colors <- rev(c(tntp_colors('green', 'medium_green'), "#eeeeee", "#cccccc", "#aaaaaa", "#888888"))
...
```{r}
# colors to use
div_scale_colors <- tntp_palette('likert_6')

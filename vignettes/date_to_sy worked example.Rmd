...
The function takes two arguements, `date_var` and `last_day_of_sy` (year doesn't matter) and returns a character string with the school year in the form '(year) - (year)'. 

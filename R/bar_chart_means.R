#' Bar chart of means with TNTP polish
#'
#' Takes a user supplied data frame and turns the designated columns into
#' a bar chart of means.
#'@rdname bar_chart_means
#'@param df the data.frame to be used in the bar chart
#'@param var unquoted column name for variable to take mean of
#'@param group_var (optional) unquoted column name for group variable.  If this is specified, you get the means broken out by subgroup.  If left blank, a single bar showing an overall mean.

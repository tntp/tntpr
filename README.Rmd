...
Last generated `r format(Sys.time(), '%B %d, %Y')`

[![Travis-CI Build Status](https://travis-ci.org/tntp/tntpr.svg?branch=master)](https://travis-ci.org/tntp/tntpr)

## About

The `tntpr` package makes data science at TNTP easier and more accurate by supplying tools that are needed for common TNTP analyses.  Because this package specifically serves the TNTP analysis community, functions can be tailored to our exact use cases.
...
See the [vignette](https://github.com/tntp/tntpr/blob/master/vignettes/tntpr-introduction.md) for demonstrations of how to use these tntpr functions.
